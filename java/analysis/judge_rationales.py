...
def create_judge_prompt(incorrect_code, error, rationale):
    instruction = "You are given an incorrect java function, an error message, and a rationale to fix the error. Classify if the rationale is 'Good' or 'Bad'. If the rationale provides enough detail to fix the code, output 'Good'. Otherwise, output 'Bad'.\n"
